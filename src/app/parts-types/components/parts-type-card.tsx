...
export function PartsTypeCard({ partsType: partsType }: { partsType: PartsType }) {
  return (
    <Card className="px-4 py-3 rounded-md">
      <CardHeader className="p-0">
        <div className="flex flex-row items-center justify-between">
          <CardTitle className="text-2xl font-bold">{partsType.name}</CardTitle>
